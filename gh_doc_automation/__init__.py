...
try:
    ...
    __GH_DOC_AUTOMATION_SETUP__
except NameError:
    __GH_DOC_AUTOMATION_SETUP__ = False

if __GH_DOC_AUTOMATION_SETUP__:
    import sys as _sys
    _sys.stdout.write('Partial import of gh_doc_automation during '
                      'the build process.\n')
    del _sys
else:
    ...
    # import 'gh_doc_automation.utils', you'd mark 'utils' here as follows:
    __all__ = [
